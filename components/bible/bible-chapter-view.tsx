...
export default function BibleChapterView({ book, chapter }: BibleChapterViewProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-16 z-10 bg-secondary-50 backdrop-blur-sm border-b">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <Card>
          <CardContent className="p-6 md:p-8 bg-secondary-50">
        ...
        <div className="flex justify-between mt-8">
          ...
          <Button variant="outline" onClick={handleBackToBible}>
