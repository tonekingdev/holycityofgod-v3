...
export default function MinistriesPage() {
  ...
  const heroContent = {
    title: content?.ministries?.title || "Our Ministries",
    description: content?.ministries?.description || "Discover the various ways you can serve and grow in your faith",
    callToAction:
      content?.ministries?.callToAction || "Get involved in a ministry that matches your passion and calling",
  }

  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      <EditPageButton pageId="ministries" />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {ministries.map((ministry) => (
            <Link key={ministry.id} href={`/our-network/ministries/${ministry.slug}`}>
